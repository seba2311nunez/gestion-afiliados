...
<body><noscript><span style="font-size:13px;font-family:arial;"><span style="color:#dd3300">Warning!</span>&nbsp&nbsp; QuickMenu may have been blocked by IE-SP2's active content option. This browser feature blocks JavaScript from running locally on your computer.<br><br>This warning will not display once the menu is on-line.  To enable the menu locally, click the yellow bar above, and select <span style="color:#0033dd;">"Allow Blocked Content"</span>.<br><br>To permanently enable active content locally...<div style="padding:0px 0px 30px 10px;color:#0033dd;"><br>1: Select 'Tools' --> 'Internet Options' from the IE menu.<br>2: Click the 'Advanced' tab.<br>3: Check the 2nd option under 'Security' in the tree (Allow active content to run in files on my computer.)</div></span></noscript><p style="background:red;text-align:center;color:ivory;padding:2em">SISTEMA DE PRUEBA</p><style>body{background:green;}</style>
...
<ul id="qm0" class="qmmc">
	...
	<li><span class="qmtitle" ><?echo $_SESSION["institucion"];?> <br>Menu Principal<br>Perfil: <?echo $_SESSION["perfil"];?></span></li>
		<li><a  class="qmparent"  title="Pagina central que se despliega al comenzar" href="../principaladm.php"  target="bottomFrame">Pagina Inicial </a></li>
	
	<li><a class="qmparent" href="#"  title="Administracion de Ventas">Padrón</a>
		<ul>
			<li><a href="../../APP/padron/buscarAfiliado.php" target="bottomFrame" title="Buscar un afiliado por cuil, dni o nombre">Trabajar con Afiliados</a></li>
			<?/*<li><a target="bottomFrame" title="Incoporar al sistema archivos de la SSS">Trabajar con TXT SSS</a>
				<ul>
					<li><a href="../../APP/padron/exportar_txt.php" title="Exportar TXT" target="bottomFrame">Exportar TXT altas, bajas manuales y modificaciones</a></li>
					<li><a href="../../APP/padron/altasSSS.php" title="Bajas SSS" target="bottomFrame">Cargar Altas SSS</a></li>
					<li><a href="../../APP/padron/bajasSSS.php" title="Bajas SSS" target="bottomFrame">Cargar Bajas SSS</a></li>
					<li><a href="../../APP/padron/inconsistenciasSSS.php" title="Inconsistencias SSS" target="bottomFrame">Cargar Inconsistencias SSS</a></li>	
				</ul>
			</li>*/?>		
		</ul>
	</li>

	<li><a class="qmparent" href="#"  title="Administracion de Ventas">Administracion Ventas</a>
		<ul>
			<li><a href="../../APP/preventa/cargaPreviaPreventa.php" target="bottomFrame"  title="Nueva Previa Preventa">Nueva PreviaPreventa</a></li>
			<li><a href="../../APP/preventa/cargaDesvinculacion.php" target="bottomFrame"  title="Cargar Desvinculacion">Cargar Desvinculacion</a></li>
			<li><a href="../../APP/preventa/verPreviaPreventa.php" target="bottomFrame" title="Ver Previa Preventa">Ver PreviaPreventas</a></li>
		</ul>
	</li>
	
	<li><a class="qmparent" href="#" title="Afiliaciones">Afiliaciones</a>
		<ul>
			<li><a href="../../APP/preventa/cargaPreventa.php" target="bottomFrame">Nueva Preventa</a></li>
			<li><a href="../../APP/preventa/eleccionPreventas.php" target="bottomFrame">Ver Preventas</a></li>
			<li><a href="../../APP/preventa/verPreventaDesactivadas.php" target="bottomFrame">Ver Preventas eliminadas</a></li>			
		</ul>
	</li>
		<li><a class="qmparent" href="#"  title="Liquidacion a vendedores de preventas realizadas">Liquidaciones</a>
		<ul>
			<li><a href="../../APP/liquidacion_vendedores/buscar_liquidacion2.php" target="bottomFrame">Listado liquidacion</a></li>
			<li><a href="../../APP/liquidacion_vendedores/buscar_liquidacion.php" target="bottomFrame">Pre-liquidacion de Ventas</a></li>
			<li><a href="../../APP/liquidacion_vendedores/buscar_liquidacion_gerente.php" target="bottomFrame">Diferencias</a></li>
			<li><a href="../../APP/liquidacion_vendedores/buscar_descuentos_preventas.php" target="bottomFrame">Descuento de preventas</a></li>
			<li><a href="../../APP/listados/listado_descuentos.php" target="bottomFrame">Listado Descuentos</a></li>
			<li><a href="../../APP/listados/todas_preventas.php" target="bottomFrame">Ventas por periodo</a></li>
			<li><a href="../../APP/listados/bajas_opcion_cambio.php" target="bottomFrame">Bajas opcion de cambio</a></li>
			<li><a class="qmparent" href="#"  title="Administracion de Ventas">Liquidaciones de Gerentes Parciales</a>
				<ul>
					<li><a href="../../APP/liquidacion_parcial/liq_buscar_parcial.php" target="bottomFrame">Listado Liquidacion Parcial</a></li>
					<li><a href="../../APP/liquidacion_parcial/liq_cierre_parcial.php" target="bottomFrame">Cierre Liquidacion Parcial</a></li>
				</ul>
			</li>		
		</ul>
	</li>
	<li ><a class="qmparent" href="#"  title="Opciones : preventas con control final efectuado">Opciones</a>
		<ul>
			<li><a href="../../APP/opciones/ver_opciones.php" target="bottomFrame">Opciones En Proceso</a></li>
			<li><a href="../../APP/opciones/ver_opciones_ospat.php" target="bottomFrame">Opciones En Proceso Ospat</a></li>
			<li><a href="../../APP/opciones/ver_opciones_oseam.php" target="bottomFrame">Opciones En Proceso Oseam</a></li>
			<li><a href="../../APP/opciones/eleccion_opciones_ospat.php" target="bottomFrame">Opciones Enviadas Ospat</a></li>
			<li><a href="../../APP/opciones/eleccion_opciones_oseam.php" target="bottomFrame">Opciones Enviadas Oseam</a></li>
		</ul>
	</li>	
	
	<li ><a class="qmparent" href="#" title="Administracion de datos">Administracion</a>
		<ul>
			<li><a class="qmparent" href="#"  title="Administracion de Ventas">Trabajar con Vendedores</a>
				<ul>
					<li><a href="../../APP/administracion/abm_vendedores/buscar_vendedor.php" target="bottomFrame">ABM de Vendedores</a></li>
					<li><a href="../../APP/administracion/abm_vendedores/escalas_comision.php" target="bottomFrame">Escalas de Gerentes</a></li>
					<li><a href="../../APP/administracion/abm_vendedores/usuarios.php" target="bottomFrame">Usuarios Vendedores</a></li>
				</ul>
			</li>
			<li><a href="../../APP/administracion/abm_controladores/ver_controlador.php" target="bottomFrame">ABM de Controladores</a></li>
			<li><a href="../../APP/administracion/m_delegacion/ver_delegacion.php" target="bottomFrame">Modificar delegacion</a></li>
			<li><a href="../../APP/administracion/trabajar_localidades/buscar_localidades.php" target="bottomFrame">Trabajar con Localidades</a></li>
			<li><a href="../../APP/administracion/abm_empresas/buscar_empresas.php" target="bottomFrame">ABM de Empresas</a></li>
			<li><a href="../../APP/administracion/periodo_actual/cerrar_liquidacion.php" target="bottomFrame">Cerrar liquidacion</a></li>
			<li><a href="../../APP/administracion/periodo_actual/periodo_actual.php" target="bottomFrame">Definir Periodo</a></li>
			<li><a href="../../APP/administracion/periodo_actual/cambiar_periodo_venta.php" target="bottomFrame">Cambiar periodo venta</a></li>				
			<li><a href="../../APP/carnets/carnets.php" target="bottomFrame">Imprimir credenciales</a></li>		
			<li><a href="../../APP/administracion/modificaciones_oficina/ver_modificaciones.php" target="bottomFrame">Cambios de Oficina</a></li>
			<li><a href="../../APP/administracion/modificaciones_oficina/ver_modificaciones_xls.php" target="bottomFrame">Cambios de Oficina xls</a></li>
		</ul>
	</li>
	
		<li><a class="qmparent" href="#"  title="Administracion de Ventas">Listados</a>
		<ul>
			<li><a class="qmparent" href="#"  title="Administracion de Ventas">Listados ventas</a>
				<ul>
					<li><a href="../../APP/listados/ventas_mes.php" target="bottomFrame">Ventas por localidad</a></li>
					<li><a href="../../APP/listados/ventas_empresa.php" target="bottomFrame">Ventas por empresa</a></li>
					<li><a href="../../APP/listados/ventas_por.php" target="bottomFrame">Ventas por jerarquía</a></li>
				</ul>
			</li>
			<li><a class="qmparent" href="#"  title="Pendientes relacionados con SSS">Listados SSS</a>
				<ul>
					<li><a href="../../APP/listados/listado_pendientes_sin_envioSSS.php" target="bottomFrame">Afiliados sin envio SSS excedidos</a></li>
					<li><a href="../../APP/listados/listado_pendientes_con_envioSSS.php" target="bottomFrame">Afiliados con envio SSS excedidos</a></li>
				</ul>
			</li>
				<li><a href="../../APP/preventa/listado_vendedores.php" target="bottomFrame" title="Listado que permite ver la escala completa desde Gerentes hasta Vendedores ">Listado de vendedores</a></li>
				<li><a href="http://replica.microteam.us/pplan/listados/listado_rechazados_periodo.php" target="bottomFrame" title="Listado de preventas rechazadas por periodo">Listado preventas rechazadas</a></li>
				<!-- <li><a href="../../APP/listados/listado_rechazados_periodo.php" target="bottomFrame" title="Listado de preventas rechazadas por periodo">Listado preventas rechazadas</a></li> -->
				<li><a href="../../APP/listados/listado_preventa.php" target="bottomFrame">Futuros afiliados</a></li>
				<li><a href="../../APP/preventa/listadoEvolucionPrepreventas.php" target="bottomFrame" title="Listado que permite hacer el seguimiento de las Pre-preventas hasta condicion de Afiliado">Evolucion de Pre-preventas</a></li>
				<li><a class="qmparent" href="#"  title="Listados certificadores">Certificadores</a>
					<ul>
						<li><a href="../../APP/listados/asignaciones_certificadores.php" target="bottomFrame" title="Listado certificadores">Listado Certificadores</a></li>
						<li><a href="../../APP/listados/asignaciones_certificadoresExcel.php" target="bottomFrame" title="Listado excel asignaciones certificadores">Excel - Asignaciones Certificadores</a></li>
						<li><a href="../../APP/listados/asignaciones_certificadoresExcel_ok.php" target="bottomFrame" title="Listado liquidacion certificadores">Excel - Liquidacion Certificadores</a></li>
					</ul>
				</li>
				<li><a href="http://replica.microteam.us/pplan/listados/afiliados_x_sanatorio.php" target="bottomFrame" title="Listado de afiliados por capita">Afiliados por sanatorio</a></li>
				<!-- <li><a href="../../APP/listados/afiliados_x_sanatorio.php" target="bottomFrame" title="Listado de afiliados por capita">Afiliados por sanatorio</a></li>	-->	
				<li><a href="../../APP/listados/listado_altas.php" target="bottomFrame">Altas por mes</a></li>
				<li><a href="../../APP/listados/listado_bajas.php" target="bottomFrame">Bajas por mes</a></li>
				<li><a href="http://replica.microteam.us/pplan/listados/padron_completo.php" target="bottomFrame">Padron Completo</a></li>
				<!-- <li><a href="../../APP/listados/padron_completo.php" target="bottomFrame">Padron Completo</a></li> -->
				<li><a href="../../APP/listados/control_finde.php" target="bottomFrame">Control de trabajo</a></li>
				<li><a href="../../APP/listados/listado_empresa.php" target="bottomFrame">Listado por empresa</a></li>
				<li><a href="../../APP/listados/listado_afiliados_am.php" target="bottomFrame">Listado afiliados en AM sin Resolucion</a></li>
				<li><a href="../../APP/listados/listado_grupo_fam_tit.php" target="bottomFrame">Listado afiliados en grupo familiar con CUIL titular (CSV)</a></li>
				<li><a href="../../APP/listados/padron_general.php" target="bottomFrame">Padron General (CSV)</a></li>
				
			</ul>
		</li>
		
		<li><a class="qmparent" href="#"  title="Listados estadisticos">Listados Estadisticos</a>
			<ul>
				<li><a href="../../APP/listados_estadisticos/capitas.php" target="bottomFrame">Capitas</a></li>
				<li><a href="../../APP/listados_estadisticos/estado_preventas.php" target="bottomFrame">Estado Preventas</a></li>
				<li><a href="../../APP/listados_estadisticos/resumen_periodo.php" target="bottomFrame">Resumen Periodo</a></li>
				<li><a href="../../APP/listados_estadisticos/demora_certificar.php" target="bottomFrame">Demora Certificar</a></li>
				<li><a href="../../APP/listados_estadisticos/demora_envioSSS.php" target="bottomFrame">Demora Envio SSS</a></li>
				<li><a href="../../APP/listados_estadisticos/motivo_rechazos.php" target="bottomFrame">Motivos Rechazos</a></li>
				<li><a href="../../APP/listados_estadisticos/motivo_descuentos.php" target="bottomFrame">Motivos Descuentos</a></li>
				<li><a href="../../APP/listados_estadisticos/estadistica_liquidacion.php" target="bottomFrame">Estadistica Liquidaciones</a></li>
			</ul>
		</li>
	
	<li><span class="qmtitle" >MicroTeam <br> Sistemas Medicos</span></li>
	<li><a  class="qmtitle" title="Enviar mail al departamento de sistemas: sistemas@smadm.com" href="mailto:sistemas@smadm.com" style="cursor:pointer">Realizar Consulta</a></li>

<li class="qmclear">&nbsp;</li></ul>

<!-- Create Menu Settings: (Menu ID, Is Vertical, Show Timer, Hide Timer, On Click, Right to Left, Horizontal Subs, Flush Left) -->
<script type="text/javascript">qm_create(0,true,0,500,true,false,false,false);</script>
