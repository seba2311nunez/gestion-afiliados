...
<body>
	<div>
		<div class="list-group">
			...
			<a href='../../APP/listados/descargar_legajos_subidos.php' class='list-group-item list-group-item-action list-group-item-dark darker' target="bottomFrame">
				<p class='mb-0 text-light'>
					<i class="fas fa-lg fa-user mr-2"></i>
					Listar Legajos
				</p>
...
<script>
	...
	$('#perfil_activo').html(perfil_texto).css('textTransform', 'capitalize');;
