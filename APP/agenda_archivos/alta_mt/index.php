...
<body>
	...
	<div class="container" id='container_form'>
		<div class="x_panel">
				<div class="tituloDiv">
					Subir un nuevo archivo de <b>ALTA MONOTRIBUTISTA</b>
				</div>
				<!-- Form de carga -->
	...
	<script>
	var error_periodo = "Existe un archivo de Alta MONOTRIBUTISTA con este periodo, por favor chequee la lista para saber si ya esta cargado. ";
	var error_tipo_archivo = "No es un archivo 'Alta MONOTRIBUTISTA' ";
