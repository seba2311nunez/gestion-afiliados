...
<head>
	<meta charset="UTF-8">
	<title>BAJAS MT | Opc MT Bajas Revision</title>
	<!-- Jquery -->
...
<body>
	...
	<div class="container" id='container_form'>
		...
		<div class="row" style="width: 600px;">
			<div class="x_panel">
				<div class="tituloDiv">
					Subir un nuevo archivo de <b>traspasos | Bajas MT</b>
				</div>
				<!-- Form de carga -->
...
<script>
	var error_periodo = "Existe uno o mas archivos de Opciones MT revision con este rango de fechas, por favor chequee la lista para saber si ya esta cargado. ";
	var error_tipo_archivo = "No es un archivo 'Opciones MT revision BAJAS' ";
