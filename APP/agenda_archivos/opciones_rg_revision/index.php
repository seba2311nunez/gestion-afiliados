...
<script>
	...
	function CargarResumenAltas(periodo){
	  ...
	  $.getJSON('ajax.php',
	    { parametro:'TraerResumenAltasBajasRg', periodo: periodo }, // <-- CAMBIO
	    function(data){
	      dtResumenAltas.clear();

	      if(!data || !data.length || data[0]['error']){
	        var msg = (periodo && periodo!='') ? 'No hay resultados para el periodo seleccionado.' : 'No hay resultados en los últimos meses.';
