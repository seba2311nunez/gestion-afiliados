...
<body>
	...
	<div class="container" id='container_form'>
		<div class="col-md-8">
			<div class="x_panel">
				<div class="tituloDiv">
					Subir un nuevo archivo de <b>Novedades SSS</b>
				</div>
				<!-- Form de carga -->
					...
					<div style="width: 600px;">						
						<form method="post" name="form1" id="form1" >	
							...
							<table class="table">
								...
								<tr>
								    <td>
								        <div style="color: red; font-weight: bold; font-size: 18px; margin-bottom: 5px;">
								            Solo se debe subir el archivo TXT (no ZIP)
								        </div>
...
<script>
	var error_periodo = "Existe un archivo de Novedades-sss con este periodo, por favor chequee la lista para saber si ya esta cargado. ";
	var primer_dia = '' ;
	//var periodo = '<?php /* echo substr($periodo,0,strlen($periodo)-3); */?>';

	var periodo = '<?php echo $periodo; ?>';

	var INST_RNOS= <?=INST_RNOS;?>;
	var nombre_validacion = `Novedades-sss-${INST_RNOS}`;
	var error_tipo_archivo = `No es un archivo de '${nombre_validacion}'`;
		...
		*/
		$('#btnEnviar').on('click',function(){
			...
			if(conf){
				...
				var n = archivo_nombre.includes('Novedades-sss-'+INST_RNOS);
				
				if(archivo_nombre != nombre_validacion){
    ...
    */
    ...
    function BuscarPeriodo(nombre_archivo){
    	var bp_periodo = nombre_archivo.substr(7, 6);
    	
    	$.getJSON('sd_discapacitados_ajax.php',
