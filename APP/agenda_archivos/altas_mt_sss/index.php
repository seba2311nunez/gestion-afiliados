...
<body>
	...
	<div class="container" id='container_form'>
		<div class="x_panel">
				<div class="tituloDiv">
					Subir un nuevo archivo de <b>Altas Monotributistas a partir de 2021-01</b> 
				</div>
				<!-- Form de carga -->
...
<script>
	...
	var nombre_validacion = `a_${INST_RNOS}`;

	var periodo  = '<?php echo $periodo; ?>';
	var error_periodo = "Existe un archivo de Altas Monotributistas con este periodo, por favor chequee la lista para saber si ya esta cargado. ";
	var error_tipo_archivo = `No es un archivo 'Altas Monotributistas' <b>${nombre_validacion}</b>`;
	var periodo  = '<?php echo $periodo; ?>';
