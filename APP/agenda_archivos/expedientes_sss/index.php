...
<body>
	...
	<div class="container" id='container_form'>
		<div class="x_panel">
				<div class="tituloDiv">
					Subir un nuevo archivo de <b>Expedientes AFIP a partir de 2021-01</b> 
				</div>
				<!-- Form de carga -->
...
<script>
	var error_periodo = "Existe un archivo de Expedientes SSS con este periodo, por favor chequee la lista para saber si ya esta cargado. ";
	var error_tipo_archivo = "No es un archivo 'Expedientes SSS' ";
				...
				$.ajax({url: 'ajax.php',
					...
					success: function(data){
						...
						if(data == 1){//PANTALLA DE ERROR POR INTENTAR CARGAR UN ARCHIVO A UN PERIODO YA USADO
							...
							if(archivo_nombre != 'e'+INST_RNOS){//En caso que el nombre del archivo no sea el indicado. Esta validacion deberia estar mas arriba...
								$('#container_error').css("display", "block");
