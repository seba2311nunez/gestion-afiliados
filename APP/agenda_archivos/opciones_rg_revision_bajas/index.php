...
<body>
	...
	<div class="container" id='container_form'>
        ...
        <div style="margin: 10px 0;">
            <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#ModalResumenBajas">
		  ...
		  <div class="modal-dialog modal-lg" role="document">
		    <div class="modal-content">
		      <div class="modal-header">
		        ...
		        <h4 class="modal-title">Resumen RG (Altas y Bajas)</h4>
		      </div>
		      ...
		      <div class="modal-body">
		        ...
		        <div class="alert alert-warning" id="alertResumenBajas" style="display:none; margin-top:10px;"></div>
...
<script>
    ...
    function CargarResumenBajas(periodo){
		    ...
		    $.ajax({
		        ...
		        dataType: 'json',
		        data: {
		            parametro: 'TraerResumenAltasBajasRg',
		            periodo: (periodo || '')
		        },
		        success: function(data){
