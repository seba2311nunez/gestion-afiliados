...
<body>
	...
	<div class="container" id='container_form'>
		<div class="x_panel">
				<div class="tituloDiv">
					Subir un nuevo archivo de <b>Efectores a partir de 2021-01</b> 
				</div>
				<!-- Form de carga -->
...
<script>
	var error_periodo = "Existen ya 2 archivos de Efectores SSS con este periodo, por favor chequee la lista para saber si ya esta cargado. ";
	var error_tipo_archivo = "No es un archivo 'Efectores SSS' ";
			...
			if(conf){
				...
				$.ajax({url: 'ajax.php',
					...
					success: function(data){
						...
						console.log("Validando periodo: "+data);
						...
						switch(data){
							...
							case '0':
								...
								if(archivo_nombre != 'ef_'+INST_RNOS){//En caso que el nombre del archivo no sea el indicado. Esta validacion deberia estar mas arriba...
									$('#container_error').css("display", "block");

								 	$('#container_form').css("display", "none");

								 	$('#mensaje_error').text(error_tipo_archivo + " " + archivo_nombre+" ef_"+INST_RNOS);
								}
								else{
							...
							case '1':
								var datos = {
									"parametro": "id_lote_para_quincena_2",
									"periodo": var_periodo
								};
								...
								$.ajax({
									...
									success: function(data){						
										...
										if(archivo_nombre != 'ef_'+INST_RNOS){//En caso que el nombre del archivo no sea el indicado. Esta validacion deberia estar mas arriba...
										    ...
										    form_data.append('periodo', var_periodo);
										    form_data.append('extension', archivo_ext);
										    form_data.append('id_lote', id_lote);
