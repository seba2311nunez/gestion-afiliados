...
<body>
	...
	<div class="container" id='container_form'>
		<div class="x_panel">
				<div class="tituloDiv">
					Subir un nuevo archivo de <b>Bajas Monotributistas a partir de 2021-01</b> 
				</div>
				<!-- Form de carga -->
...
<script>
	var INST_RNOS = "<?echo INST_RNOS;?>";
	var error_periodo = "Existe un archivo de Bajas Monotributistas con este periodo, por favor chequee la lista para saber si ya esta cargado. ";
	var error_tipo_archivo = "No es un archivo 'Bajas Monotributistas' <b>b_"+INST_RNOS+"</b> ";
				...
				$.ajax({url: 'ajax.php',
					...
					success: function(data){
						...
						if(data == 1){//PANTALLA DE ERROR POR INTENTAR CARGAR UN ARCHIVO A UN PERIODO YA USADO
							...
							if(archivo_nombre != 'b_'+INST_RNOS){//En caso que el nombre del archivo no sea el indicado. Esta validacion deberia estar mas arriba...
								$('#container_error').css("display", "block");
