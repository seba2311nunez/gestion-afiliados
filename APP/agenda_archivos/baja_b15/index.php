...
<head>
	<meta charset="UTF-8">
	<title>Archivos Bajas B15</title>
	<!-- Jquery -->
...
<body>
	...
	<div class="container" id='container_form'>
		<div class="x_panel">
				<div class="tituloDiv">
					Subir un nuevo archivo de <b>BAJA B15</b>
				</div>
				<!-- Form de carga -->
	...
	<script>
	var error_periodo = "Existe un archivo de BAJA B15 con este periodo, por favor chequee la lista para saber si ya esta cargado. ";
	var error_tipo_archivo = "No es un archivo 'BAJA B15' ";
	var periodo  = '<?php echo $periodo; ?>';


	var INST_RNOS= <?=INST_RNOS;?>;
	console.log(INST_RNOS);
			...
			$.ajax({url: 'ajax.php',
				...
				success: function(data){
					...
					if(data == 1){//PANTALLA DE ERROR POR INTENTAR CARGAR UN ARCHIVO A UN PERIODO YA USADO
						...
						if(archivo_nombre != 'b15_'+INST_RNOS){//En caso que el nombre del archivo no sea el indicado. Esta validacion deberia estar mas arriba...
							$('#container_error').css("display", "block");
