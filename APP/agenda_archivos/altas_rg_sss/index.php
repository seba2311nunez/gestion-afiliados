		...
		<div class="x_panel">
			<div class="row">
				<div class="col-sm-7" id="formulario">
					<div class="tituloDiv">
						Subir un nuevo archivo de <b>ALTA REGIMEN GENERAL</b>
					</div>
					<!-- Form de carga -->
				...
				<div class="col-sm-5" id="listados_xls">
					<div class="tituloDiv">
						Procedencia de las opciones recibidas
					</div>
					<div class="row" style="margin: 10px;">
						<div style="width: 600px;">	
							<div class="row">
...
<script>
	...
	var nombre_validacion = `a${INST_RNOS}`;
	var error_periodo = "Existe un archivo de Alta RG con este periodo, por favor chequee la lista para saber si ya esta cargado. ";
	var error_tipo_archivo = "No es un archivo 'Alta RG' ";
	var periodo  = '<?php echo $periodo; ?>';
	var fuente = 'altas_rg_sss';//excel_procedencia
