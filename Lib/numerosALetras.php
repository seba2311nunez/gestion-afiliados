				...
				while($valor!=0){
						...
						if(($valor<1000) and ($valor>99)){
								if ((intval($valor/100)==1) and (($valor-(intval($valor/100)*100))<1))
										...
										$letras.=(string) $l2.' ';
										if((intval($valor/100)<>1) && (intval($valor/100)<>5) && (intval($valor/100)<>7) && (intval($valor/100)<>9))
										{		
											if((intval($valor/100)==2))
													$letras.='doscientos ';
											if((intval($valor/100)==3))
													$letras.='trescientos ';
											if((intval($valor/100)==4))
													$letras.='cuatrocientos ';											
											if((intval($valor/100)==6))
													$letras.='seiscientos ';											
											if((intval($valor/100)==8))
													$letras.='ochocientos ';										
										}
									}
